...
! function() {
    ...
    window.Framework7 = function(a) {
        ...
        }, i.ls = window.localStorage, i.rtl = "rtl" === s("body").css("direction"), i.rtl && s("html").attr("dir", "rtl"), "undefined" != typeof i.params.statusbarOverlay && (i.params.statusbarOverlay ? s("html").addClass("with-statusbar-overlay") : s("html").removeClass("with-statusbar-overlay")), i.views = [];
        var p = function(e, a) {
            var t, n = {
                dynamicNavbar: !1,
                domCache: !1,
            ...
            var l = s(e);
            if (o.container = l[0], o.main = l.hasClass(i.params.viewMainClass), o.contentCache = {}, o.pagesCache = {}, l[0].f7View = o, o.pagesContainer = l.find(".pages")[0], o.initialPages = [], o.initialNavbars = [], o.params.domCache) {
                var p = l.find(".page");
            ...
            i.params.pushState && o.main && (m ? u = m : u.indexOf(f) >= 0 && u.indexOf(f + "#") < 0 && (u = u.split(f)[0]));
            var h, g;
            ...
            if (o.handleTouchStart = function(e) {
                    N && o.params.swipeBackPage && !I && !i.swipeoutOpenedEl && (O = !1, I = !0, v = void 0, E.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, E.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, C = (new Date).getTime(), S = o.params.dynamicNavbar && l.find(".navbar-inner").length > 1)
                    ...
                    if (I) {
                        ...
                        if (!O) {
                            ...
                            var d = E.x - l.offset().left > o.params.swipeBackPageActiveArea;
                            if (d = i.rtl ? E.x < l.offset().left - l[0].scrollLeft + w - o.params.swipeBackPageActiveArea : E.x - l.offset().left > o.params.swipeBackPageActiveArea, d && (n = !0), (0 === D.length || 0 === L.length) && (n = !0), n) return void(I = !1);
                            o.params.swipeBackPageAnimateShadow && !i.device.android && (P = L.find(".swipeback-page-shadow"), 0 === P.length && (P = s('<div class="swipeback-page-shadow"></div>'), L.append(P))), S && (B = l.find(".navbar-on-center:not(.cached)"), z = l.find(".navbar-on-left:not(.cached)"), y = B.find(".left, .center, .right, .subnavbar, .fading"), x = z.find(".left, .center, .right, .subnavbar, .fading"), i.params.animateNavBackIcon && (T = B.find(".left.sliding .back .icon"), k = z.find(".left.sliding .back .icon"))), s(".picker-modal.modal-in").length > 0 && i.closeModal(s(".picker-modal.modal-in"))
                        }
                        e.f7PreventPanelSwipe = !0, O = !0, e.preventDefault();
                        var c = i.rtl ? -1 : 1;
                        b = (a - E.x - o.params.swipeBackPageThreshold) * c, 0 > b && (b = 0);
                        var u = b / w,
                            f = {
                                percentage: u,
                                activePage: L[0],
                        ...
                        o.params.onSwipeBackMove && o.params.onSwipeBackMove(f), l.trigger("swipebackmove", f);
                        var m = b * c,
                            h = (b / 5 - w / 5) * c;
                        if (1 === i.device.pixelRatio && (m = Math.round(m), h = Math.round(h)), L.transform("translate3d(" + m + "px,0,0)"), o.params.swipeBackPageAnimateShadow && !i.device.android && (P[0].style.opacity = 1 - 1 * u), D.transform("translate3d(" + h + "px,0,0)"), o.params.swipeBackPageAnimateOpacity && (D[0].style.opacity = .9 + .1 * u), S) {
                            var g;
                            for (g = 0; g < y.length; g++)
                                if (M = s(y[g]), M.is(".subnavbar.sliding") || (M[0].style.opacity = 1 - 1.3 * u), M[0].className.indexOf("sliding") >= 0) {
                            ...
                            for (g = 0; g < x.length; g++)
                                if (M = s(x[g]), M.is(".subnavbar.sliding") || (M[0].style.opacity = 1.3 * u - .3), M[0].className.indexOf("sliding") >= 0) {
                                    var N = M[0].f7NavbarLeftOffset * (1 - u);
                                    1 === i.device.pixelRatio && (N = Math.round(N)), M.transform("translate3d(" + N + "px,0,0)"), i.params.animateNavBackIcon && M[0].className.indexOf("left") >= 0 && k.length > 0 && k.transform("translate3d(" + -N + "px,0,0)")
                                }
                        }
                    }
                }, o.handleTouchEnd = function() {
                    if (!I || !O) return I = !1, void(O = !1);
                    if (I = !1, O = !1, 0 === b) return s([L[0], D[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    ...
                    var e = (new Date).getTime() - C,
                        a = !1;
                    if ((300 > e && b > 10 || e >= 300 && b > w / 2) && (L.removeClass("page-on-center").addClass("page-on-right"), D.removeClass("page-on-left").addClass("page-on-center"), S && (B.removeClass("navbar-on-center").addClass("navbar-on-right"), z.removeClass("navbar-on-left").addClass("navbar-on-center")), a = !0), s([L[0], D[0]]).transform("").css({
                            opacity: "",
                            boxShadow: ""
                        ...
                        }).addClass("page-transitioning")), N = !1, o.allowPageChange = !1, a) {
                        var t = o.history[o.history.length - 2];
                        o.url = t, i.pageBackCallback("before", o, {
                            pageContainer: L[0],
                            url: t,
                            position: "center",
                            newPage: D,
                    ...
                    L.transitionEnd(function() {
                        s([L[0], D[0]]).removeClass("page-transitioning"), S && (y.removeClass("page-transitioning").css({
                            opacity: ""
                        }), x.removeClass("page-transitioning").css({
                            opacity: ""
                        }), T && T.length > 0 && T.removeClass("page-transitioning"), k && k.length > 0 && k.removeClass("page-transitioning")), N = !0, o.allowPageChange = !0, a && (i.params.pushState && o.main && history.back(), i.pageBackCallback("after", o, {
                            pageContainer: L[0],
                            url: t,
                            position: "center",
                            newPage: D,
                            ...
                            oldPage: L,
                            swipeBack: !0
                        }), i.router.afterBack(o, L, D)), P && P.length > 0 && P.remove()
                    })
                ...
                var A;
                m ? A = c.split(i.params.pushStateRoot + f)[1] : c.indexOf(f) >= 0 && c.indexOf(f + "#") < 0 && (A = c.split(f)[1]);
                ...
                if (A) i.router.load(o, {
                    ...
                    var R = history.state;
                    R.pageName && "viewIndex" in R && i.router.load(o, {
                        pageName: R.pageName,
                        pushState: !1
                    })
                }
        ...
        i.addView = function(e, a) {
            ...
            var a = s(".popover.modal-in .view"),
                t = s(".popup.modal-in .view"),
                n = s(".panel.active .view"),
                r = s(".views"),
                i = r.children(".view");
            ...
            if (i.length > 0) {
                ...
                if (i.length > 1) {
                    for (var o = [], l = 0; l < i.length; l++) i[l].f7View && o.push(i[l].f7View);
                    return o.length > 0 && "undefined" != typeof e ? o[e] : o.length > 1 ? o : 1 === o.length ? o[0] : void 0
                }
            }
            return void 0
        }, i.navbarInitCallback = function(e, a, t, n) {
            !t && n && (t = s(n).parent(".navbar")[0]);
            var r = {
                    container: t,
                    innerContainer: n
                },
            ...
            return n.f7NavbarInitialized ? (i.reinitNavbar(t, n), i.pluginHook("navbarReinit", o), void s(o.container).trigger("navbarReinit", l)) : (n.f7NavbarInitialized = !0, i.pluginHook("navbarBeforeInit", r, o), s(n).trigger("navbarBeforeInit", l), i.initNavbar(t, n), i.pluginHook("navbarInit", r, o), void s(n).trigger("navbarInit", l))
            ...
            i.pluginHook("navbarBeforeRemove", r, o), s(n).trigger("navbarBeforeRemove", l)
        }, i.initNavbar = function(e, a) {
            i.initSearchbar(a)
        }, i.reinitNavbar = function() {}, i.initNavbarWithCallback = function(e) {
            e = s(e);
            var a = e.parents("." + i.params.viewClass);
            if (0 !== a.length) {
                var t = a[0].f7View || void 0;
                e.find(".navbar-inner").each(function() {
                    i.navbarInitCallback(t, void 0, e[0], this)
                })
            }
        ...
        var d = function(e, a) {
            ...
            var o = this;
            o.params = a, e = s(e), o.container = e, o.active = !1, o.input = o.params.input ? s(o.params.input) : o.container.find('input[type="search"]'), o.clearButton = o.params.clearButton ? s(o.params.clearButton) : o.container.find(".searchbar-clear"), o.cancelButton = o.params.cancelButton ? s(o.params.cancelButton) : o.container.find(".searchbar-cancel"), o.searchList = s(o.params.searchList), o.ul = o.searchList.children("ul"), o.isVirtualList = o.searchList.hasClass("virtual-list"), o.pageContainer = o.container.parents(".page").eq(0), o.overlay = o.params.overlay ? s(o.params.overlay) : o.pageContainer.length > 0 ? o.pageContainer.find(".searchbar-overlay") : s(".searchbar-overlay"), o.found = o.params.found ? s(o.params.found) : o.pageContainer.length > 0 ? o.pageContainer.find(".searchbar-found") : s(".searchbar-found"), o.notFound = o.params.notFound ? s(o.params.notFound) : o.pageContainer.length > 0 ? o.pageContainer.find(".searchbar-not-found") : s(".searchbar-not-found");
            var l = i.rtl ? "margin-left" : "margin-right";
            o.cancelButton.length > 0 && (o.cancelButton.transition(0).show(), o.cancelButton.css(l, -o.cancelButton[0].offsetWidth + "px"), setTimeout(function() {
                o.cancelButton.transition("")
            }, 0)), o.triggerEvent = function(e, a) {
                o.container.trigger(e, a), o.searchList.length > 0 && o.searchList.trigger(e, a)
            }, o.enable = function() {
                function e() {
                    o.searchList.length && !o.container.hasClass("searchbar-active") && o.overlay.addClass("searchbar-overlay-active"), o.container.addClass("searchbar-active"), o.cancelButton.length > 0 && o.cancelButton.css(l, "0px"), o.triggerEvent("enableSearch"), o.active = !0
                }
                ...
                function e() {
                    o.input.blur(), o.triggerEvent("disableSearch"), o.active = !1
                }
                o.input.val("").trigger("change"), o.container.removeClass("searchbar-active searchbar-not-empty"), o.cancelButton.length > 0 && o.cancelButton.css(l, -o.cancelButton[0].offsetWidth + "px"), o.searchList.length && o.overlay.removeClass("searchbar-overlay-active"), i.device.ios ? setTimeout(function() {
                    e()
                }, 400) : e()
            }, o.clear = function() {
                o.input.val("").trigger("change").focus(), o.triggerEvent("clearSearch")
            }, o.handleInput = function() {
                setTimeout(function() {
                    var e = o.input.val().trim();
                    o.searchList.length > 0 && (o.params.searchIn || o.isVirtualList) && o.search(e, !0)
                }, 0)
            };
            var p, d;
            return o.search = function(e, a) {
                if (e.trim() !== p) {
                    if (p = e.trim(), a || (o.active || o.enable(), a || o.input.val(e)), 0 === e.length ? (o.container.removeClass("searchbar-not-empty"), o.searchList.length && o.container.hasClass("searchbar-active") && o.overlay.addClass("searchbar-overlay-active")) : (o.container.addClass("searchbar-not-empty"), o.searchList.length && o.container.hasClass("searchbar-active") && o.overlay.removeClass("searchbar-overlay-active")), o.params.externalSearch) return void o.triggerEvent("search", {
                        query: e
                    });
                    ...
                    if (o.isVirtualList) {
                        ...
                        if (d.params.searchAll) n = d.params.searchAll(e, d.items) || [];
                        else if (d.params.searchByItem)
                            for (var r = 0; r < d.items.length; r++) d.params.searchByItem(e, r, d.params.items[r]) && n.push(r)
                    } else 0 === o.ul.length && (o.ul = o.searchList.children("ul")), o.ul.children("li").removeClass("hidden-by-searchbar").each(function(e, a) {
                        a = s(a);
                        var r = [];
                        a.find(o.params.searchIn).each(function() {
                            r.push(s(this).text().trim().toLowerCase())
                        }), r = r.join(" ");
                        for (var i = 0, l = 0; l < t.length; l++) r.indexOf(t[l]) >= 0 && i++;
                        i === t.length || o.params.ignore && a.is(o.params.ignore) ? n.push(a[0]) : a.addClass("hidden-by-searchbar")
                    }), i.params.searchbarHideDividers && o.searchList.find(".item-divider, .list-group-title").each(function() {
                        ...
                        var i = o.params.ignore && e.is(o.params.ignore);
                        t && !i ? e.addClass("hidden-by-searchbar") : e.removeClass("hidden-by-searchbar")
                    }), i.params.searchbarHideGroups && o.searchList.find(".list-group").each(function() {
                        var e = s(this),
                    ...
                    o.triggerEvent("search", {
                        query: e,
                        foundItems: n
                    }), 0 === n.length ? (o.notFound.show(), o.found.hide()) : (o.notFound.hide(), o.found.show()), o.isVirtualList && d.filterItems(n)
                }
            }, o.attachEvents = function(e) {
                var a = e ? "off" : "on";
                o.container[a]("submit", t), o.cancelButton[a]("click", o.disable), o.overlay[a]("click", o.disable), o.input[a]("focus", o.enable), o.input[a]("change keydown keypress keyup", o.handleInput), o.clearButton[a]("click", o.clear)
            }, o.detachEvents = function() {
                o.attachEvents(!0)
            }, o.init = function() {
                o.attachEvents()
        ...
        var c = function(e, a) {
            ...
            for (var r in n)("undefined" == typeof a[r] || null === a[r]) && (a[r] = n[r]);
            var i = this;
            return i.params = a, i.container = s(e), 0 !== i.container.length ? (i.textarea = i.params.textarea ? s(i.params.textarea) : i.container.find("textarea"), i.pageContainer = i.container.parents(".page").eq(0), i.pageContent = i.pageContainer.find(".page-content"), i.pageContentPadding = parseInt(i.pageContent.css("padding-bottom")), i.initialBarHeight = i.container[0].offsetHeight, i.initialAreaHeight = i.textarea[0].offsetHeight, i.sizeTextarea = function() {
                i.textarea.css({
                    height: ""
                });
                ...
                if (t + a > e) {
                    var n = t + a,
                        ...
                        o = i.params.maxHeight || i.container.parents(".view")[0].offsetHeight - 88;
                    r > o && (r = parseInt(o, 10), n = r - i.initialBarHeight + i.initialAreaHeight), i.textarea.css("height", n + "px"), i.container.css("height", r + "px"), i.pageContent.length > 0 && (i.pageContent.css("padding-bottom", r + "px"), i.pageContent.scrollTop(i.pageContent[0].scrollHeight - i.pageContent[0].offsetHeight))
            ...
            }, i.textareaTimeout = void 0, i.handleTextarea = function() {
        ...
        i.triggerPageCallbacks = function(e, a, t) {
            ...
            e = s(e), i.sizeNavbars && i.sizeNavbars(e.parents("." + i.params.viewClass)[0]), i.initPageMessages && i.initPageMessages(e), i.initFormsStorage && i.initFormsStorage(e), i.initSmartSelects && i.initSmartSelects(e), i.initPageSwiper && i.initPageSwiper(e), i.initPullToRefresh && i.initPullToRefresh(e), i.initInfiniteScroll && i.initInfiniteScroll(e), i.initSearchbar && i.initSearchbar(e), i.initPageMessagebar && i.initPageMessagebar(e), i.initScrollToolbars && i.initScrollToolbars(e), i.initImagesLazyLoad && i.initImagesLazyLoad(e)
        }, i.reinitPage = function(e) {
            e = s(e), i.sizeNavbars && i.sizeNavbars(e.parents("." + i.params.viewClass)[0]), i.reinitPageSwiper && i.reinitPageSwiper(e), i.reinitLazyLoad && i.reinitLazyLoad(e)
            ...
            preprocess: function(e, a, t, n) {
                i.pluginHook("routerPreprocess", e, a, t, n), a = i.pluginProcess("preprocess", a), e && e.params && e.params.preprocess ? (a = e.params.preprocess(a, t, n), console.log(a), "undefined" != typeof a && n(a)) : i.params.preprocess ? (a = i.params.preprocess(a, t, n), "undefined" != typeof a && n(a)) : n(a)
            },
            ...
            template7Render: function(e, a) {
                ...
                if ("string" == typeof o ? r ? i.template7Cache[r] ? n = l.cache[r] : (n = l.compile(o), l.cache[r] = n) : n = l.compile(o) : u && (n = u), d) t = d;
                else {
                    if (c)
                        if (c.indexOf(".") >= 0) {
                    ...
                    if (!t && r && (t = l.data["url:" + r]), !t && "string" == typeof o && !u) {
            ...
            if (n.addClass(a.reload ? "page-on-" + f : "page-on-right"), o = C.children(".page:not(.cached)"), a.reload && a.reloadPrevious && 1 === o.length) return void(e.allowPageChange = !0);
            ...
            if (e.params.domCache && n.removeClass("cached"), e.params.dynamicNavbar)
                ...
                for (l = 0; l < p.length - 1; l++) e.params.domCache ? s(p[l]).addClass("cached") : (i.navbarRemoveCallback(e, o[l], c[0], p[l]), s(p[l]).remove());
                d || 1 !== p.length || (e.params.domCache ? s(p[0]).addClass("cached") : (i.navbarRemoveCallback(e, o[0], c[0], p[0]), s(p[0]).remove())), p = c.find(".navbar-inner:not(.cached)")
            }
            ...
            function o() {
                ...
                if (e.params.dynamicNavbar && "undefined" == typeof m && (m = c && 0 !== c.length ? !0 : !1), p.addClass("page-on-left").removeClass("cached"), m && (u = k.find(".navbar"), f = k.find(".navbar-inner:not(.cached)"), c.addClass("navbar-on-left").removeClass("cached")), x) {
                    var t, r;
                    t = s(P[P.length - 2]), m && (r = s(t[0] && t[0].f7RelatedNavbar || f[f.length - 2])), e.params.domCache && e.initialPages.indexOf(t[0]) >= 0 ? (t.length && t[0] !== p[0] && t.addClass("cached"), m && r.length && r[0] !== c[0] && r.addClass("cached")) : (t.length && t.remove(), m && r.length && r.remove()), P = S.children(".page:not(.cached)"), m && (f = k.find(".navbar-inner:not(.cached)")), e.history.indexOf(h) >= 0 ? e.history = e.history.slice(0, e.history.indexOf(h) + 2) : e.history[[e.history.length - 2]] ? e.history[e.history.length - 2] = h : e.history.unshift(h)
                }
                if (l = s(P[P.length - 1]), e.params.domCache && l[0] === p[0] && (l = S.children(".page.page-on-center"), 0 === l.length && e.activePage && (l = s(e.activePage.container))), m && !d && (d = s(f[f.length - 1]), e.params.domCache && (d[0] === c[0] && (d = u.children(".navbar-inner.navbar-on-center:not(.cached)")), 0 === d.length && (d = u.children('.navbar-inner[data-page="' + l.attr("data-page") + '"]'))), (0 === d.length || c[0] === d[0]) && (m = !1)), m && (M && c.insertBefore(d), c[0].f7RelatedPage = p[0], p[0].f7RelatedNavbar = c[0]), M && p.insertBefore(l), i.pageInitCallback(e, {
                        pageContainer: p[0],
                        url: h,
                        position: "left",
            ...
            if (e.params.dynamicNavbar) {
                ...
                e.params.domCache && e.initialNavbars.indexOf(l[0]) >= 0 ? l.removeClass("navbar-from-center-to-right").addClass("cached") : (i.navbarRemoveCallback(e, a[0], void 0, l[0]), l.remove()), n = s(o[0]).removeClass("navbar-on-left navbar-from-left-to-center").addClass("navbar-on-center")
            }
        ...
        i.modalStack = [], i.modalStackClearQueue = function() {
            ...
            if (o) {
                ...
                m.innerHTML = p, t = s(m).children(), s("body").append(t[0]), n = ".actions-modal-group", r = ".actions-modal-button"
            }
            var w = t.find(n);
            ...
            function n() {
                ...
                var p = a.outerWidth(),
                    ...
                    c = a.offset(),
                    u = a.parents(".page");
                u.length > 0 && (c.top = c.top - u[0].scrollTop);
                var f = s(window).height(),
                    m = s(window).width(),
                    h = 0,
                    g = 0,
                    v = 0,
                    w = "top";
                i + l < c.top ? h = c.top - i - l : i + l < f - c.top - d ? (w = "bottom", h = c.top + d + l) : (w = "middle", h = d / 2 + c.top - i / 2, v = h, 0 > h ? h = 5 : h + i > f && (h = f - i - 5), v -= h), "top" === w || "bottom" === w ? (g = p / 2 + c.left - r / 2, v = g, 5 > g && (g = 5), g + r > m && (g = m - r - 5), "top" === w && o.addClass("on-bottom"), "bottom" === w && o.addClass("on-top"), v -= g, t = r / 2 - l + v, t = Math.max(Math.min(t, r - 2 * l - 6), 6), o.css({
                    left: t + "px"
            ...
            function e(e) {
                if (i.allowPanelOpen && (i.params.swipePanel || i.params.swipePanelOnlyClose) && !o && !(s(".modal-in, .photo-browser-in").length > 0 || !i.params.swipePanelCloseOpposite && !i.params.swipePanelOnlyClose && s(".panel.active").length > 0 && !n.hasClass("active"))) {
                    if (w.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, w.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, i.params.swipePanelCloseOpposite || i.params.swipePanelOnlyClose) {
                        if (s(".panel.active").length > 0) r = s(".panel.active").hasClass("panel-left") ? "left" : "right";
                        else {
                    ...
                    if (n = s(".panel.panel-" + r), f = n.hasClass("active"), i.params.swipePanelActiveArea && !f) {
            ...
            function t() {
                ...
                var e, a = (new Date).getTime() - d,
                    t = 0 === u || Math.abs(u) === m;
                if (e = f ? u === -m ? "reset" : 300 > a && Math.abs(u) >= 0 || a >= 300 && Math.abs(u) <= m / 2 ? "left" === r && u === m ? "reset" : "swap" : "reset" : 0 === u ? "reset" : 300 > a && Math.abs(u) > 0 || a >= 300 && Math.abs(u) >= m / 2 ? "swap" : "reset", "swap" === e && (i.allowPanelOpen = !0, f ? (i.closePanel(), t && (n.css({
                        display: ""
            ...
            var o, l, p, d, c, u, f, m, h, g, v = s(".panel-overlay"),
                w = {},
        ...
        var h = function(e, a) {
            ...
            var r = this;
            return r.params = a, r.container = s(e), 0 !== r.container.length ? (r.params.autoLayout && r.container.addClass("messages-auto-layout"), r.pageContainer = r.container.parents(".page").eq(0), r.pageContent = r.pageContainer.find(".page-content"), r.template = Template7.compile(r.params.messageTemplate), r.layout = function() {
                ...
                for (n = 0; n < e.length; n++) {
                    var o = e[n] || {};
                    o.type = o.type || "sent", o.text && (o.hasImage = o.text.indexOf("<img") >= 0, t && (o.position = "append" === a ? "bottom" : "top"), i += r.template(o))
                }
                ...
                var s = r.container.find(".message");
                if (1 === e.length) return "append" === a ? s[s.length - 1] : s[0];
                var l = [];
                if ("append" === a)
                    for (n = s.length - e.length; n < s.length; n++) l.push(s[n]);
                else
                    for (n = 0; n < e.length; n++) l.push(s[n]);
                return l
            }, r.removeMessage = function(e) {
                return e = s(e), 0 === e.length ? !1 : (e.remove(), r.params.autoLayout && r.layout(), !0)
        ...
        i.messages = function(e, a) {
            ...
            function a(e) {
                i.allowSwipeout && (o = !1, r = !0, l = void 0, O.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, O.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, p = (new Date).getTime())
            }
            ...
            function t(e) {
                if (r) {
                    ...
                    if (!o) {
                        ...
                        c = s(this), u = c.find(".swipeout-content"), f = c.find(".swipeout-actions-right"), m = c.find(".swipeout-actions-left"), h = g = C = y = k = T = null, M = m.hasClass("swipeout-actions-no-fold") || i.params.swipeoutActionsNoFold, I = f.hasClass("swipeout-actions-no-fold") || i.params.swipeoutActionsNoFold, m.length > 0 && (h = m.outerWidth(), C = m.children("a"), T = m.find(".swipeout-overswipe")), f.length > 0 && (g = f.outerWidth(), y = f.children("a"), k = f.find(".swipeout-overswipe")), w = c.hasClass("swipeout-opened"), w && (b = c.find(".swipeout-actions-left.swipeout-actions-opened").length > 0 ? "left" : "right"), c.removeClass("transitioning"), i.params.swipeoutNoFollow || (c.find(".swipeout-actions-opened").removeClass("swipeout-actions-opened"), c.removeClass("swipeout-opened"))
                    }
                    if (o = !0, e.preventDefault(), d = a - O.x, v = d, w && ("right" === b ? v -= g : v += h), v > 0 && 0 === m.length || 0 > v && 0 === f.length) {
                        if (!w) return void(r = o = !1);
                        v = 0
                    }
                    x = 0 > v ? "to-left" : v > 0 ? "to-right" : x ? x : "to-left";
                    var n, p, E;
                    if (e.f7PreventPanelSwipe = !0, i.params.swipeoutNoFollow) return w ? ("right" === b && d > 0 && i.swipeoutClose(c), "left" === b && 0 > d && i.swipeoutClose(c)) : (0 > d && f.length > 0 && i.swipeoutOpen(c, "right"), d > 0 && m.length > 0 && i.swipeoutOpen(c, "left")), r = !1, void(o = !1);
                    S = !1, P = !1;
                    var L;
                    if (f.length > 0)
                        for (E = v / g, -g > v && (v = -g - Math.pow(-v - g, .8), k.length > 0 && (P = !0)), n = 0; n < y.length; n++) "undefined" == typeof y[n]._buttonOffset && (y[n]._buttonOffset = y[n].offsetLeft), p = y[n]._buttonOffset, L = s(y[n]), k.length > 0 && L.hasClass("swipeout-overswipe") && L.css({
                            left: (P ? -p : 0) + "px"
                        }), L.transform("translate3d(" + (v - p * (1 + Math.max(E, -1))) + "px,0,0)");
                    if (m.length > 0)
                        for (E = v / h, v > h && (v = h + Math.pow(v - h, .8), T.length > 0 && (S = !0)), n = 0; n < C.length; n++) "undefined" == typeof C[n]._buttonOffset && (C[n]._buttonOffset = h - C[n].offsetLeft - C[n].offsetWidth), p = C[n]._buttonOffset, L = s(C[n]), T.length > 0 && L.hasClass("swipeout-overswipe") && L.css({
                            left: (S ? p : 0) + "px"
            ...
            function n() {
                ...
                if (b = "to-left" === x ? I : M, t = "to-left" === x ? f : m, a = "to-left" === x ? g : h, e = 300 > T && (-10 > d && "to-left" === x || d > 10 && "to-right" === x) || T >= 300 && Math.abs(v) > a / 2 ? "open" : "close", 300 > T && (0 === Math.abs(v) && (e = "close"), Math.abs(v) === a && (e = "open")), "open" === e) {
                    i.swipeoutOpenedEl = c, c.trigger("open"), c.addClass("swipeout-opened transitioning");
                    var k = "to-left" === x ? -a : a;
                    if (u.transform("translate3d(" + k + "px,0,0)"), t.addClass("swipeout-actions-opened"), n = "to-left" === x ? y : C)
                ...
                } else c.trigger("close"), i.swipeoutOpenedEl = void 0, c.addClass("transitioning").removeClass("swipeout-opened"), u.transform(""), t.removeClass("swipeout-actions-opened");
                var O;
                if (C && C.length > 0 && C !== n)
                    for (l = 0; l < C.length; l++) O = C[l]._buttonOffset, "undefined" == typeof O && (C[l]._buttonOffset = h - C[l].offsetLeft - C[l].offsetWidth), s(C[l]).transform("translate3d(" + O + "px,0,0)");
                if (y && y.length > 0 && y !== n)
                    for (l = 0; l < y.length; l++) O = y[l]._buttonOffset, "undefined" == typeof O && (y[l]._buttonOffset = y[l].offsetLeft), s(y[l]).transform("translate3d(" + -O + "px,0,0)");
                u.transitionEnd(function() {
                    w && "open" === e || closed && "close" === e || (c.trigger("open" === e ? "opened" : "closed"), w && "close" === e && (f.length > 0 && y.transform(""), m.length > 0 && C.transform("")))
                })
            }
            var r, o, l, p, d, c, u, f, m, h, g, v, w, b, C, y, x, T, k, S, P, M, I, O = {};
            ...
            function t() {
                i.allowSwipeout = !0, o.transform(""), e.trigger("closed"), a && a.call(e[0]), p && clearTimeout(p)
            }
            if (e = s(e), 0 !== e.length && e.hasClass("swipeout-opened")) {
                var n = e.find(".swipeout-actions-opened").hasClass("swipeout-actions-right") ? "right" : "left",
                    ...
                    o = (r.hasClass("swipeout-actions-no-fold") || i.params.swipeoutActionsNoFold, r.children("a")),
                    l = r.outerWidth();
                ...
                for (var d = 0; d < o.length; d++) s(o[d]).transform("right" === n ? "translate3d(" + -o[d].offsetLeft + "px,0,0)" : "translate3d(" + (l - o[d].offsetWidth - o[d].offsetLeft) + "px,0,0)"), s(o[d]).css({
                    left: "0px"
                });
            ...
            function a(e) {
                if (n && p) {
                    ...
                    r || (p.addClass("sorting"), g.addClass("sortable-sorting"), u = p[0].offsetTop, f = p.parent().height() - p[0].offsetTop - p.height(), d = p[0].offsetHeight), r = !0, e.preventDefault(), e.f7PreventPanelSwipe = !0, l = a - o;
            ...
            "undefined" == typeof t ? e.append(a) : s(a).insertBefore(e.find("option").eq(t)), i.initSmartSelects(n);
            var r = n.find("select").attr("name"),
                o = s('.page.smart-select-page[data-select-name="' + r + '"]').length > 0;
            o && i.smartSelectOpen(n, !0)
            ...
            function t(a) {
                if (g) {
                    ...
                    s(a).once("popup" === o ? "closed" : "pageBeforeRemove", function() {
                        t && t.destroy && t.destroy()
                    })
                }
                s(a).on("change", 'input[name="' + z + '"]', function() {
                    var a = this,
                        t = a.value,
                        n = [];
                    if ("checkbox" === a.type)
                        for (var s = 0; s < w.options.length; s++) {
                            var l = w.options[s];
                            l.value === t && (l.selected = a.checked), l.selected && n.push(l.textContent.trim())
                        } else n = [e.find('option[value="' + t + '"]').text()], w.value = t;
                    b.trigger("change"), e.find(".item-after").text(n.join(", ")), f && "radio" === B && ("popup" === o ? i.closeModal(J) : r.router.back())
                })
            }
            ...
            if (e = s(e), 0 !== e.length) {
                ...
                if (0 !== r.length && (r = r[0].f7View)) {
                    var o = e.attr("data-open-in");
                    o || (o = i.params.smartSelectInPopup ? "popup" : "page");
                    var p = e.dataset(),
                    ...
                    if (!(w.disabled || e.hasClass("disabled") || b.hasClass("disabled"))) {
                        ...
                        var q, Y = i._compiledTemplates.smartSelectNavbar({
                                pageTitle: d,
                                backText: c,
                                closeText: u,
                                openIn: o,
                                ...
                                inPopup: "popup" === o,
                                inPage: "page" === o,
                                leftTemplate: "popup" === o ? i.params.smartSelectPopupCloseTemplate.replace(/{{closeText}}/g, u) : i.params.smartSelectBackTemplate.replace(/{{backText}}/g, c)
                            }),
                            G = "",
                            W = "";
                        "page" === o ? (q = "static", e.parents(".navbar-through").length > 0 && (q = "through"), e.parents(".navbar-fixed").length > 0 && (q = "fixed"), W = e.parents(".page").hasClass("no-toolbar") ? "no-toolbar" : "", G = e.parents(".page").hasClass("no-navbar") ? "no-navbar" : "navbar-" + q) : q = "fixed";
                        var j, _, X = "smart-select-" + z,
                        ...
                        var J, Q = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + N + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + j + '"><a href="#" class="searchbar-clear"></a></div><a href="#" class="searchbar-cancel">' + _ + '</a></form><div class="searchbar-overlay"></div>',
                            K = ("through" === q ? Y : "") + '<div class="pages">  <div data-page="' + X + '" data-select-name="' + A + '" class="page smart-select-page ' + G + " " + W + '">' + ("fixed" === q ? Y : "") + (U ? Q : "") + '    <div class="page-content">' + ("static" === q ? Y : "") + '      <div class="list-block ' + (g ? "virtual-list" : "") + " smart-select-list-" + N + " " + (m ? "theme-" + m : "") + '">        <ul>' + (g ? "" : V) + "        </ul>      </div>    </div>  </div></div>";
                        "popup" === o ? (a ? (J = s(".popup.smart-select-popup .view"), J.html(K)) : (J = i.popup('<div class="popup smart-select-popup smart-select-popup-' + z + '"><div class="view navbar-fixed">' + K + "</div></div>"), J = s(J)), i.initPage(J.find(".page")), t(J)) : (s(document).once("pageInit", ".smart-select-page", n), r.router.load({
                            content: K,
                            reload: a ? !0 : void 0
                        }))
                    }
        ...
        var g = function(e, a) {
            ...
            return r.setListSize = function() {
                ...
                if ("undefined" != typeof a && (t = a), null === r.lastRepaintY || Math.abs(t - r.lastRepaintY) > h || !o && r.pageContent[0].scrollTop + p >= r.pageContent[0].scrollHeight) {
                    ...
                    } else n = (parseInt(t / r.params.height) - c) * r.params.cols, 0 > n && (n = 0), i = Math.min(n + f * r.params.cols, s.length);
                    var w;
                    r.reachEnd = !1;
                    for (var b = n; i > b; b++) {
                        var C, y;
        ...
        i.virtualList = function(e, a) {
            ...
            function a(e) {
                ...
                d = !1, p = !0, c = void 0, v = void 0, C.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, C.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, f = (new Date).getTime(), m = s(this)
            }
            ...
            function m(n) {
                ...
                if (i.params.tapHold && (O && clearTimeout(O), O = setTimeout(function() {
                        I = !0, n.preventDefault(), s(n.target).trigger("taphold")
                    }, i.params.tapHoldDelay)), N && clearTimeout(N), D = l(n.target), !D) return T = !1, !0;
                if (i.device.ios) {
                    var r = window.getSelection();
                    if (r.rangeCount && r.focusNode !== document.body && (!r.isCollapsed || document.activeElement === r.focusNode)) return k = !0, !0;
                    k = !1
                }
                i.device.android && o(n.target) && document.activeElement.blur(), T = !0, x = n.target, y = (new Date).getTime(), b = n.targetTouches[0].pageX, C = n.targetTouches[0].pageY, i.device.ios && (S = void 0, s(x).parents().each(function() {
                    var e = this;
            ...
            function h(e) {
                if (T) {
                    ...
                    if (t) {
                        ...
                        (Math.abs(r - b) > t || Math.abs(o - C) > t) && (a = !0)
                    } else a = !0;
            ...
            function g(e) {
                ...
                var a = e.changedTouches[0],
                    ...
                    o = "click";
                return i.device.android && "select" === x.nodeName.toLowerCase() && (o = "mousedown"), r.initMouseEvent(o, !0, !0, window, 1, a.screenX, a.screenY, a.clientX, a.clientY, !1, !1, !1, !1, 0, null), r.forwardedTouchEvent = !0, x.dispatchEvent(r), !1
            }
            ...
            function w(e) {
                var a = !1;
                return T ? (x = null, T = !1, !0) : "submit" === e.target.type && 0 === e.detail ? !0 : (x || r(e.target) || (a = !0), D || (a = !0), document.activeElement === x && (a = !0), e.forwardedTouchEvent && (a = !0), e.cancelable || (a = !0), i.params.tapHold && i.params.tapHoldPreventClicks && I && (a = !1), a || (e.stopImmediatePropagation(), e.stopPropagation(), x ? (d(x) || M) && e.preventDefault() : e.preventDefault(), x = null), N = setTimeout(function() {
                    D = !1
            ...
            i.params.activeState && s("html").addClass("watch-active-state"), i.device.ios && i.device.webView && window.addEventListener("touchstart", function() {});
            var b, C, y, x, T, k, S, P, M, I, O, E, L, D, N;
            ...
            function a(e) {
                ...
                if (a.hasClass("smart-select") && i.smartSelectOpen && i.smartSelectOpen(a), a.hasClass("open-panel") && i.openPanel(1 === s(".panel").length ? s(".panel").hasClass("panel-left") ? "left" : "right" : "right" === r.panel ? "right" : "left"), a.hasClass("close-panel") && i.closePanel(), a.hasClass("panel-overlay") && i.params.panelsCloseByOutside && i.closePanel(), a.hasClass("open-popover")) {
                    var o;
                    o = r.popover ? r.popover : ".popover", i.popover(o, a)
                }
                ...
                if ((!i.params.ajaxLinks || a.is(i.params.ajaxLinks)) && n && i.params.router) {
                    ...
                    if (w || a.hasClass("back") || b) {
                        var C;
                        if (r.view ? C = s(r.view)[0].f7View : (C = a.parents("." + i.params.viewClass)[0] && a.parents("." + i.params.viewClass)[0].f7View, C && C.params.linksView && ("string" == typeof C.params.linksView ? C = s(C.params.linksView)[0].f7View : C.params.linksView instanceof p && (C = C.params.linksView))), C || i.mainView && (C = i.mainView), !C) return;
                        var y;
                        if (b) t = void 0;
                        else {
                            if (0 === t.indexOf("#") && "#" !== t) {
            ...
            s(document).on("click", "a, .open-panel, .close-panel, .panel-overlay, .modal-overlay, .popup-overlay, .swipeout-delete, .swipeout-close, .close-popup, .open-popup, .open-popover, .open-login-screen, .close-login-screen .smart-select, .toggle-sortable, .open-sortable, .close-sortable, .accordion-item-toggle, .close-picker", a), (i.params.scrollTopOnNavbarClick || i.params.scrollTopOnStatusbarClick) && s(document).on("click", ".statusbar-overlay, .navbar .center", e), i.support.touch && s(document).on(i.params.fastClicks ? "touchstart" : "touchmove", ".panel-overlay, .modal-overlay, .preloader-indicator-overlay, .popup-overlay, .searchbar-overlay", t)
            ...
            if (0 !== n.length)
                for (var r = 0; r < n.length; r++) {
                    var o, l = n.eq(r);
                    o = l.data("swiper") ? JSON.parse(l.data("swiper")) : l.dataset();
        ...
        var v = function(e) {
            ...
            t.activeIndex = t.params.initialSlide, t.openIndex = t.activeIndex, t.opened = !1, t.open = function(e) {
                ...
                var a = {
                    ...
                    onLazyImageReady: function(e, a, n) {
                        s(a).removeClass("photo-browser-slide-lazy"), t.params.onLazyImageReady && t.params.onLazyImageReady(t, a, n)
                    }
                };
            ...
            var M, I, O, E, L, D, N, B, z, A, H, R, V, F, q, Y, G, W = {},
                j = {};
            t.onSlideTouchStart = function(e) {
                ...
                if (x && 0 !== x.length && (t.swiper.allowClick = !1, M && y)) {
                    I || (z = x[0].offsetWidth, A = x[0].offsetHeight, H = s.getTranslate(T[0], "x") || 0, R = s.getTranslate(T[0], "y") || 0, T.transition(0));
                    var a = z * k,
                        n = A * k;
                    if (!(a < t.swiper.width && n < t.swiper.height)) {
                        if (L = Math.min(t.swiper.width / 2 - a / 2, 0), N = -L, D = Math.min(t.swiper.height / 2 - n / 2, 0), B = -D, j.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, j.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !I && !P && (Math.floor(L) === Math.floor(H) && j.x < W.x || Math.floor(N) === Math.floor(H) && j.x > W.x)) return void(M = !1);
                        e.preventDefault(), e.stopPropagation(), I = !0, O = j.x - W.x + H, E = j.y - W.y + R, L > O && (O = L + 1 - Math.pow(L - O + 1, .8)), O > N && (O = N - 1 + Math.pow(O - N + 1, .8)), D > E && (E = D + 1 - Math.pow(D - E + 1, .8)), E > B && (E = B - 1 + Math.pow(E - B + 1, .8)), V || (V = j.x), Y || (Y = j.y), F || (F = Date.now()), q = (j.x - V) / (Date.now() - F) / 2, G = (j.y - Y) / (Date.now() - F) / 2, Math.abs(j.x - V) < 2 && (q = 0), Math.abs(j.y - Y) < 2 && (G = 0), V = j.x, Y = j.y, F = Date.now(), T.transform("translate3d(" + O + "px, " + E + "px,0)")
                    }
                }
                ...
                if (x && 0 !== x.length) {
                    ...
                    var e = 300,
                        ...
                        i = G * a,
                        o = E + i;
                    0 !== q && (e = Math.abs((r - O) / q)), 0 !== G && (a = Math.abs((o - E) / G));
                    var s = Math.max(e, a);
                    O = r, E = o;
                    var l = z * k,
                        p = A * k;
                    L = Math.min(t.swiper.width / 2 - l / 2, 0), N = -L, D = Math.min(t.swiper.height / 2 - p / 2, 0), B = -D, O = Math.max(Math.min(O, N), L), E = Math.max(Math.min(E, B), D), T.transition(s).transform("translate3d(" + O + "px, " + E + "px,0)")
                }
            };
            var _, X, U, J, Q, K = !1,
                Z = !0,
        ...
        var w = function(e) {
            function a() {
                var e = !1;
                return p.params.convertToPopover || p.params.onlyInPopover ? (!p.inline && p.params.input && (p.params.onlyInPopover ? e = !0 : i.device.ios ? e = i.device.ipad ? !0 : !1 : s(window).width() >= 768 && (e = !0)), e) : e
            }
            ...
            return p.setValue = function(e, a) {
                ...
                function n(e) {
                    y || C || (e.preventDefault(), C = !0, x = T = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, k = (new Date).getTime(), D = !0, P = I = s.getTranslate(f.wrapper[0], "y"))
                }

                function r(e) {
                    if (C) {
                        e.preventDefault(), D = !1, T = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, y || (s.cancelAnimationFrame(b), y = !0, P = I = s.getTranslate(f.wrapper[0], "y"), f.wrapper.transition(0)), e.preventDefault();
                        var a = T - x;
                ...
                function o() {
                    ...
                    var e, a;
                    S - k > 300 ? a = I : (e = Math.abs(E / (S - L)), a = I + E * p.params.momentumRatio), a = Math.max(Math.min(a, w), v);
                    var n = -Math.floor((a - w) / h);
                    p.params.freeMode || (a = -n * h + w), f.wrapper.transform("translate3d(0," + parseInt(a, 10) + "px,0)"), f.updateItems(n, a, "", !0), p.params.updateValuesOnMomentum && (t(), f.wrapper.transitionEnd(function() {
                ...
                if (!f.divider) {
                    ...
                    f.setValue = function(e, a, n) {
                        ...
                        if ("undefined" != typeof r && -1 !== r) {
                            var i = -r * h + w;
                            f.wrapper.transition(a), f.wrapper.transform("translate3d(0," + i + "px,0)"), p.params.updateValuesOnMomentum && f.activeIndex && f.activeIndex !== r && (s.cancelAnimationFrame(b), f.wrapper.transitionEnd(function() {
                                s.cancelAnimationFrame(b)
                            }), t()), f.updateItems(r, i, a, n)
                        }
                    }, f.updateItems = function(e, a, t, n) {
                        "undefined" == typeof a && (a = s.getTranslate(f.wrapper[0], "y")), "undefined" == typeof e && (e = -Math.round((a - w) / h)), 0 > e && (e = 0), e >= f.items.length && (e = f.items.length - 1);
                        var r = f.activeIndex;
                        ...
                        if ((n || "undefined" == typeof n) && (f.value = i.attr("data-picker-value"), f.displayValue = f.displayValues ? f.displayValues[e] : f.value, r !== e && (f.onChange && f.onChange(p, f.value, f.displayValue), p.updateValue())), p.params.rotateEffect) {
                            ...
                            f.items.each(function() {
                                var e = s(this),
                                    ...
                                    r = t - n,
                                    i = r / h,
                                    o = Math.ceil(f.height / h / 2) + 1,
                                    l = -18 * i;
                                l > 180 && (l = 180), -180 > l && (l = -180), Math.abs(i) > o ? e.addClass("picker-item-far") : e.removeClass("picker-item-far"), e.transform("translate3d(0, " + (-a + w) + "px, " + (u ? -110 : 0) + "px) rotateX(" + l + "deg)")
                            })
                        }
                    ...
                    f.initEvents = function(e) {
                        var a = e ? "off" : "on";
                        f.container[a](i.touchEvents.start, n), f.container[a](i.touchEvents.move, r), f.container[a](i.touchEvents.end, o), f.items[a]("click", l)
        ...
        var b = function(e) {
            ...
            return p.animating = !1, p.addValue = function(e) {
                ...
                function e(e) {
                    o || r || (r = !0, l = f = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, d = f = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, m = (new Date).getTime(), C = 0, T = !0, x = void 0, g = v = p.monthsTranslate)
                }
                ...
                function a(e) {
                    if (r) {
                        ...
                        T = !1, o || (o = !0, w = p.wrapper[0].offsetWidth, b = p.wrapper[0].offsetHeight, p.wrapper.transition(0)), e.preventDefault(), y = p.isH ? c - l : f - d, C = y / (p.isH ? w : b), v = 100 * (p.monthsTranslate * u + C), p.wrapper.transform("translate3d(" + (p.isH ? v : 0) + "%, " + (p.isH ? 0 : v) + "%, 0)")
                    }
                }
                ...
                var r, o, l, d, c, f, m, h, g, v, w, b, C, y, x, T = !0;
        ...
        return i.initPlugins = function() {
            ...
            }), s(".navbar:not(.cached)").each(function() {
    ...
    var e = function() {
        ...
        return a.ajax = function(e) {
                ...
                if (("GET" === l || "HEAD" === l) && e.data) {
                    var p;
                    p = "string" == typeof e.data ? e.data.indexOf("?") >= 0 ? e.data.split("?")[1] : e.data : a.serializeObject(e.data), e.url += s + p
                }
                ...
                return g.onload = function() {
                    if (T && clearTimeout(T), g.status >= 200 && g.status < 300 || 0 === g.status) {
                        ...
                        if ("json" === e.dataType) try {
                            a = JSON.parse(g.responseText), r("ajaxSuccess", {
                                xhr: g
            ...
            function() {
                ...
                return 4 === arguments.length && "function" == typeof r && (i = r, r = void 0), this.each(function() {
                    function o(e) {
                        ...
                        return g && (f = s + d * (c - s)), v && (m = l + d * (u - l)), g && c > s && f >= c && (h.scrollTop = c, t = !0), g && s > c && c >= f && (h.scrollTop = c, t = !0), v && u > l && m >= u && (h.scrollLeft = u, t = !0), v && l > u && u >= m && (h.scrollLeft = u, t = !0), t ? void(i && i()) : (g && (h.scrollTop = f), v && (h.scrollLeft = m), void a.requestAnimationFrame(o))
                    }
                    ...
                    if ("undefined" == typeof r && (r = "swing"), g && (s = h.scrollTop, n || (h.scrollTop = t)), v && (l = h.scrollLeft, n || (h.scrollLeft = e)), n) {
                        ...
                        var w = null;
                        g && c === s && (g = !1), v && u === l && (v = !1), a.requestAnimationFrame(o)
                    }
                })
    ...
    window.Dom7 = e, Framework7.prototype.support = function() {
        ...
        var r = function(e) {
            ...
            function r(e, a) {
                ...
                for (var o = 0; o < n.length; o++) {
                    var s = n[o];
                    0 === s.indexOf("@") ? o > 0 ? t += "[(data && data." + s.replace("@", "") + ")]" : t = "(data && data." + e.replace("@", "") + ")" : isFinite(s) ? t += "[" + s + "]" : 0 === s.indexOf("this") ? t = s.replace("this", a) : t += "." + s
                }
                return t
            }
                ...
                for (c = 0; c < l.length; c++) {
                    ...
                    if ("plain" !== u.type) {
                        ...
                        if ("variable" === u.type && (f = r(u.contextName, p), d += "r += c(" + f + ", " + p + ");"), "helper" === u.type)
                            if (u.helperName in s.helpers) m = i(u.contextName, p), d += "r += (Template7.helpers." + u.helperName + ").call(" + p + ", " + (m && m + ", ") + "{hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, o + 1) + ", inverse: " + t(u, o + 1) + ", root: ctx_1});";
                            else {
                                if (u.contextName.length > 0) throw new Error('Template7: Missing helper: "' + u.helperName + '"');
                                f = r(u.helperName, p), d += "if (" + f + ") {", d += "if (isArray(" + f + ")) {", d += "r += (Template7.helpers.each).call(" + p + ", " + f + ", {hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, o + 1) + ", inverse: " + t(u, o + 1) + ", root: ctx_1});", d += "}else {", d += "r += (Template7.helpers.with).call(" + p + ", " + f + ", {hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + a(u, o + 1) + ", inverse: " + t(u, o + 1) + ", root: ctx_1});", d += "}}"
                            }
        ...
        r.prototype = {
            ...
            helpers: {
                ...
                js: function(e) {
                    var a;
                    return a = e.indexOf("return") >= 0 ? "(function(){" + e + "})" : "(function(){return (" + e + ")})", eval.call(this, a).call(this)
                },
        ...
        if (m = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e, m && (f.$ = m, f.container = m(a), 0 !== f.container.length)) {
            ...
            f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push("swiper-container-" + f.params.direction), f.params.freeMode && f.classNames.push("swiper-container-free-mode"), f.support.flexbox || (f.classNames.push("swiper-container-no-flexbox"), f.params.slidesPerColumn = 1), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push("swiper-container-3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push("swiper-container-" + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0, f.params.setWrapperSize = !1), "fade" === f.params.effect && (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, "undefined" == typeof d && (f.params.virtualTranslate = !0)), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = m(f.params.pagination), f.params.paginationClickable && f.paginationContainer.addClass("swiper-pagination-clickable")), f.rtl = n() && ("rtl" === f.container[0].dir.toLowerCase() || "rtl" === f.container.css("direction")), f.rtl && f.classNames.push("swiper-container-rtl"), f.rtl && (f.wrongRTL = "-webkit-box" === f.wrapper.css("display")), f.params.slidesPerColumn > 1 && f.classNames.push("swiper-container-multirow"), f.device.android && f.classNames.push("swiper-container-android"), f.container.addClass(f.classNames.join(" ")), f.translate = 0, f.progress = 0, f.velocity = 0, f.lockSwipeToNext = function() {
                ...
                f.width = f.container[0].clientWidth, f.height = f.container[0].clientHeight, f.size = n() ? f.width : f.height
                ...
                if (f.rtl && f.wrongRTL && ("slide" === f.params.effect || "coverflow" === f.params.effect) && f.wrapper.css({
                    ...
                    }), f.params.slidesPerColumn > 1 && (f.virtualSize = (s + f.params.spaceBetween) * o, f.virtualSize = Math.ceil(f.virtualSize / f.params.slidesPerColumn) - f.params.spaceBetween, f.wrapper.css({
                        width: f.virtualSize + f.params.spaceBetween + "px"
                ...
                if ("undefined" == typeof e && (e = f.translate || 0), 0 !== f.slides.length) {
                    ...
                    for (var t = 0; t < f.slides.length; t++) {
                        var r = f.slides[t],
                            ...
                            o = (a - r.swiperSlideOffset - i) / (r.swiperSlideSize + f.params.spaceBetween);
                        if (f.params.watchSlidesVisibility) {
                            var s = -(a - r.swiperSlideOffset - i),
                                l = s + f.slidesSizesGrid[t],
                                p = s >= 0 && s < f.size || l > 0 && l <= f.size || 0 >= s && l >= f.size;
                            p && f.slides.eq(t).addClass(f.params.slideVisibleClass)
                        }
                        r.progress = f.rtl ? -o : o
                    }
                }
            ...
            window.navigator.pointerEnabled ? h = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (h = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), f.touchEvents = {
                ...
                if (f.clickedSlide = a, f.clickedIndex = m(a).index(), f.params.slideToClickedSlide && void 0 !== f.clickedIndex && f.clickedIndex !== f.activeIndex) {
                    var t, n = f.clickedIndex;
                    if (f.params.loop)
                        if (t = m(f.clickedSlide).attr("data-swiper-slide-index"), n > f.slides.length - f.params.slidesPerView) f.fixLoop(), n = f.wrapper.children("." + f.params.slideClass + '[data-swiper-slide-index="' + t + '"]').eq(0).index(), setTimeout(function() {
                            f.slideTo(n)
                        }, 0);
                        else if (n < f.params.slidesPerView - 1) {
                        f.fixLoop();
                        var r = f.wrapper.children("." + f.params.slideClass + '[data-swiper-slide-index="' + t + '"]');
            ...
            f.onTouchStart = function(e) {
                ...
                if (e.originalEvent && (e = e.originalEvent), f.emit("onTouchEnd", f, e), g) {
                    ...
                    if (n = f.params.followFinger ? f.rtl ? f.translate : -f.translate : -C, f.params.freeMode) {
                        ...
                        if (n > -f.maxTranslate()) return void f.slideTo(f.slides.length - 1);
                        if (f.params.freeModeMomentum) {
                            if (M.length > 1) {
                                var r = M.pop(),
                                    i = M.pop(),
                                    o = r.position - i.position,
                                    s = r.time - i.time;
                                f.velocity = o / s, f.velocity = f.velocity / 2, Math.abs(f.velocity) < .02 && (f.velocity = 0), (s > 150 || (new Date).getTime() - r.time > 300) && (f.velocity = 0)
                            } else f.velocity = 0;
                            M.length = 0;
                            ...
                            d < f.maxTranslate() && (f.params.freeModeMomentumBounce ? (d + f.maxTranslate() < -h && (d = f.maxTranslate() - h), c = f.maxTranslate(), u = !0, k = !0) : d = f.maxTranslate()), d > f.minTranslate() && (f.params.freeModeMomentumBounce ? (d - f.minTranslate() > h && (d = f.minTranslate() + h), c = f.minTranslate(), u = !0, k = !0) : d = f.minTranslate()), 0 !== f.velocity && (l = Math.abs(f.rtl ? (-d - f.translate) / f.velocity : (d - f.translate) / f.velocity)), f.params.freeModeMomentumBounce && u ? (f.updateProgress(c), f.setWrapperTransition(l), f.setWrapperTranslate(d), f.onTransitionStart(), f.animating = !0, f.wrapper.transitionEnd(function() {
                                k && (f.emit("onMomentumBounce", f), f.setWrapperTransition(f.params.speed), f.setWrapperTranslate(c), f.wrapper.transitionEnd(function() {
                                    f.onTransitionEnd()
                                }))
                    ...
                    for (b = 0; b < f.slidesGrid.length; b += f.params.slidesPerGroup) "undefined" != typeof f.slidesGrid[b + f.params.slidesPerGroup] ? n >= f.slidesGrid[b] && n < f.slidesGrid[b + f.params.slidesPerGroup] && (x = b, S = f.slidesGrid[b + f.params.slidesPerGroup] - f.slidesGrid[b]) : n >= f.slidesGrid[b] && (x = b, S = f.slidesGrid[f.slidesGrid.length - 1] - f.slidesGrid[f.slidesGrid.length - 2]);
                    var I = (n - f.slidesGrid[x]) / S;
                    if (t > f.params.longSwipesMs) {
                        if (!f.params.longSwipes) return void f.slideTo(f.activeIndex);
                        "next" === f.swipeDirection && f.slideTo(I >= f.params.longSwipesRatio ? x + f.params.slidesPerGroup : x), "prev" === f.swipeDirection && f.slideTo(I > 1 - f.params.longSwipesRatio ? x + f.params.slidesPerGroup : x)
                    } else {
                        if (!f.params.shortSwipes) return void f.slideTo(f.activeIndex);
                        "next" === f.swipeDirection && f.slideTo(x + f.params.slidesPerGroup), "prev" === f.swipeDirection && f.slideTo(x)
                    }
                }
                ...
                for (var o = 0; o < f.slidesGrid.length; o++) - i >= f.slidesGrid[o] && (e = o);
                ...
                var r = 0,
                    i = 0,
                    o = 0;
                n() ? r = f.rtl ? -e : e : i = e, f.params.virtualTranslate || f.wrapper.transform(f.support.transforms3d ? "translate3d(" + r + "px, " + i + "px, " + o + "px)" : "translate(" + r + "px, " + i + "px)"), f.translate = n() ? r : i, a && f.updateActiveIndex(), "slide" !== f.params.effect && f.effects[f.params.effect] && f.effects[f.params.effect].setTranslate(f.translate), f.params.parallax && f.parallax && f.parallax.setTranslate(f.translate), f.params.scrollbar && f.scrollbar && f.scrollbar.setTranslate(f.translate), f.params.control && f.controller && f.controller.setTranslate(f.translate, t), f.emit("onSetTranslate", f, f.translate)
                ...
                if (f.params.observeParents)
                    for (var e = f.container.parents(), a = 0; a < e.length; a++) o(e[a]);
                o(f.container[0], {
                    childList: !1
                }), o(f.wrapper[0], {
                    attributes: !1
                ...
                fade: {
                    ...
                    setTranslate: function() {
                        for (var e = 0; e < f.slides.length; e++) {
                            ...
                            var i = 0;
                            n() || (i = r, r = 0);
                            var o = f.params.fade.crossFade ? Math.max(1 - Math.abs(a[0].progress), 0) : 1 + Math.min(Math.max(a[0].progress, -1), 0);
                            o > 0 && 1 > o && (f.effects.fade.fadeIndex = e), a.css({
                                opacity: o
                    ...
                    setTranslate: function() {
                        ...
                        for (var t = 0; t < f.slides.length; t++) {
                            ...
                            var s = Math.max(Math.min(r[0].progress, 1), -1),
                                ...
                                p = 0,
                                d = 0;
                            t % 4 === 0 ? (l = 4 * -o * f.size, d = 0) : (t - 1) % 4 === 0 ? (l = 0, d = 4 * -o * f.size) : (t - 2) % 4 === 0 ? (l = f.size + 4 * o * f.size, d = f.size) : (t - 3) % 4 === 0 && (l = -f.size, d = 3 * f.size + 4 * f.size * o), f.rtl && (l = -l), n() || (p = l, l = 0);
                            var c = "rotateX(" + (n() ? 0 : -i) + "deg) rotateY(" + (n() ? i : 0) + "deg) translate3d(" + l + "px, " + p + "px, " + d + "px)";
                            if (1 >= s && s > -1 && (a = 90 * t + 90 * s, f.rtl && (a = 90 * -t - 90 * s)), r.transform(c), f.params.cube.slideShadows) {
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var e = f.translate, a = n() ? -e + f.width / 2 : -e + f.height / 2, t = n() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, r = f.params.coverflow.depth, i = 0, o = f.slides.length; o > i; i++) {
                            var s = f.slides.eq(i),
                            ...
                            if (s.transform(w), s[0].style.zIndex = -Math.abs(Math.round(d)) + 1, f.params.coverflow.slideShadows) {
                                ...
                                0 === b.length && (b = m('<div class="swiper-slide-shadow-' + (n() ? "left" : "top") + '"></div>'), s.append(b)), 0 === C.length && (C = m('<div class="swiper-slide-shadow-' + (n() ? "right" : "bottom") + '"></div>'), s.append(C)), b.length && (b[0].style.opacity = d > 0 ? d : 0), C.length && (C[0].style.opacity = -d > 0 ? -d : 0)
                            }
                        }
                        if (f.browser.ie) {
                ...
                setTranslate: function(e, a) {
                    ...
                    else r instanceof Swiper && a !== r && (e = r.rtl && "horizontal" === r.params.direction ? -f.translate : f.translate, t = (r.maxTranslate() - r.minTranslate()) / (f.maxTranslate() - f.minTranslate()), n = (e - f.minTranslate()) * t + r.minTranslate(), f.params.controlInverse && (n = r.maxTranslate() - n), r.updateProgress(n), r.setWrapperTranslate(n, !1, f), r.updateActiveIndex())
                },
                setTransition: function(e, a) {
                    var t = f.params.control;
                    if (f.isArray(t))
                        for (var n = 0; n < t.length; n++) t[n] !== a && t[n] instanceof Swiper && t[n].setWrapperTransition(e, f);
